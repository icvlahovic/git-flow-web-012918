describe "GIT" do
    ...
    it "4. What command allows you to add all previously tracked, modified files
...
# describe "BRANCHING:" do
    ...
    it "33. If you clone down a repo at noon and don't touch it but three minutes later,
